...
class ViewScene(var camera: CameraProperties = CameraProperties()) {
    ...
    fun update(): FloatArray {
        ...
        Matrix.setLookAtM(
            ...
            camera.cameraDirectionPoint.x + camera.cameraPosition.x,//
            camera.cameraDirectionPoint.y + camera.cameraPosition.y,//
            camera.cameraDirectionPoint.z + camera.cameraPosition.z,//
            camera.upVector.x,
            camera.upVector.y,
            camera.upVector.z
        )
